        ...
        <div className="flex justify-between">
            <div>
                <a href={props.link_left}>
                    <img src={props.src_left} alt={props.alt_left} className="h-20 md:h-30 object-cover pb-2"></img>
                </a>
            ...
            <div className="text-right">
                <a href={props.link_right}>
                    <img src={props.src_right} alt={props.alt_right} className="ml-auto h-20 md:h-30 object-cover pb-2"></img>
                </a>
