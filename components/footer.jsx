    ...
    return (
        <>
            ...
            <div className="flex justify-between font-semibold">
                ...
                <a href="#top" className="hover:text-teal hover:underline decoration-2 underline-offset-3 transition duration-300">Back to Top<i className="fa-solid fa-angles-up ml-1 text-xs"></i></a>
            </div>
        </>
    )
}